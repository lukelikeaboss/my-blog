...
<nav class="navbar navbar-expand-md bg-gradient navbar-dark">
    ...
    <a href="/" class="navbar-brand"> <img src="{{asset('images/logo.png')}}" class="img-fluid logo-image" alt="Brand logo"></a>
        ...
        <ul class="navbar-nav ml-auto navbar-dark text-dark ">
            ...
            @guest
                            ...
                            @if (Route::has('register'))
                                <li class="nav-item">
                                    <a class="btn btn-success rounded-pill px-3" href="{{ route('register') }}">{{ __('Register') }}</a>
                                </li>
                            @endif
                        @else
                            <li class="nav-item dropdown">
                                <a id="navbarDropdown" class="btn btn-success rounded-pill px-3 dropdown-toggle" href="#" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" v-pre>
                                    {{ Auth::user()->name }}
                                </a>
