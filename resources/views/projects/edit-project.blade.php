...
<div class="container ">
    <div class="row justify-content-center">
        <h3 class="font-weight-bold text-success "><i class="fa fa-edit"></i> Edit Project</h3>
    </div>
<hr>
                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('update.project', $project->id) }}" method="post">
                        ...
                        <div class="form-group">
                             <label> Name:</label>
                             <input type="text" name="name" class="form-control" value="{{ $project->name }}" placeholder="Your Name">
                        </div>
                        ...
                        <div class="form-group">
                             <input type="file"  name="featured_image_url" value="{{ $project->featured_image_url }}" class="form-control" placeholder="">
                            <label> Url:</label> <input type="text" name="code_url" value="{{ $project->code_url }}" class="form-control" placeholder="Enter Git url">
                        </div>
